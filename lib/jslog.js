        ...
        var JsLogOptions = (function () {
            ...
            JsLog = (function () {
                ...
                JsLog.prototype.log = function () {
                    return sendUnifiedLogEntry(this, 'log', arguments);
                };

                JsLog.prototype.info = function () {
                    return sendUnifiedLogEntry(this, 'info', arguments);
                };

                JsLog.prototype.warn = function () {
                    return sendUnifiedLogEntry(this, 'warn', arguments);
                };

                JsLog.prototype.error = function () {
                    return sendUnifiedLogEntry(this, 'error', arguments);
                };

                JsLog.prototype.exception = function (data) {
                    return sendUnifiedLogEntry(this, 'exception', arguments);
                };

                JsLog.prototype.network = function () {
                    return sendUnifiedLogEntry(this, 'network', arguments);
                };
